...
Phases 1-3 built (scaffolding, ACO, Markov Chain -- all three paths running simultaneously). Phase 4 (analysis tooling) not yet started. See `design-docs/upstream-rl.md` (not part of this repo) for the full project prompt. This file tracks the decisions actually made while building it, and the tradeoffs behind them.
