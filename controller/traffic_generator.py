...
def run(tick_seconds, rps, duration_minutes):
    ...
    # blip) and this run's own traffic phase deserves the same loud,
    # actionable failure a startup-time outage would get, rather than
    # silently generating a run's worth of broken data.
